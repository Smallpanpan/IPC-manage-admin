        ...
        <el-row>
          ...
          <el-col :span="24">
            <el-form-item label="封面(940x470):" prop="coverImg">
              <Croppa ref="coverImg" v-model="postForm.coverImg" :width="470" :height="235" :quality="2"/>
            </el-form-item>
              ...
              <el-row>
                ...
                <el-col :span="6">
                  <el-form-item label="推荐:" label-width="45px" class="postInfo-container-item">
                    <el-checkbox v-model="postForm.recommendFlag" style="min-width:200px;" label="首页" border/>
                  </el-form-item>
                </el-col>
...
export default {
  ...
  methods: {
    ...
    async submitForm() {
      const res = await this.$refs['coverImg'].upload()
      if (res) {
